...
When output names a domain concept, use the term as defined in `CONTEXT.md`. If the concept is absent, reconsider the terminology or note the gap for `/domain-modeling`.
